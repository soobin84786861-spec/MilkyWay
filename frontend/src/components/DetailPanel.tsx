...
export default function DetailPanel({ district, isTop5District, onClose }: Props) {
                    ...
                    {isTop5District && (
                      <>
                        <div className="space-y-2">
                          ...
                          {aiData.actionGuides.map((guide, index) => (
                            <div
                              key={index}
                        ...
                        <div className="space-y-2">
                          ...
                          {aiData.riskFactors.map((factor, index) => (
                            <div
                              key={index}
